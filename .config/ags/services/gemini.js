...
const initMessages =
    [
        ...
        { role: "user", parts: [{ text: "\"He rushed to where the event was supposed to be hold, he didn't know it got canceled\"" }], },
...
const CHAT_MODELS = ["gemini-2.5-pro-preview-05-06"]
